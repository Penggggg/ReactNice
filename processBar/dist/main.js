...
/***/ function(module, exports, __webpack_require__) {
	...
	var progressBarSuccess = _actions.ProcessColors.progressBarSuccess;


	function valueState() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? 50 : arguments[0];
		var action = arguments[1];

		switch (action.type) {
			case _actions.CHANGE_VALUE:
				return action.value;
			default:
				return state;
		}
	...
	function colorState() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? progressBarSuccess : arguments[0];
		var action = arguments[1];
	...
	var processBarState = (0, _redux.combineReducers)({
		valueState: valueState,
		stripedState: stripedState,
		textState: textState,
		activeState: activeState,
		colorState: colorState
	});

	exports.default = processBarState;
...
/***/ function(module, exports) {
	...
	exports.changeStriped = changeStriped;
	exports.changeText = changeText;
	exports.changeActive = changeActive;
	exports.changColor = changColor;
	//actions类型
	var CHANGE_VALUE = exports.CHANGE_VALUE = "CHANGE_VALUE";
	var CHANGE_STRIPED = exports.CHANGE_STRIPED = "CHANGE_STRIPED";
	var CHANGE_TEXT = exports.CHANGE_TEXT = "CHANGE_TEXT";
	var CHANGE_ACTIVE = exports.CHANGE_ACTIVE = "CHANGE_ACTIVE";
	var CHANGE_COLOR = exports.CHANGE_COLOR = "CHANGE_COLOR";

	//其他常量
	var ProcessColors = exports.ProcessColors = {
	...
	function changeStriped(isStriped) {
		return { type: CHANGE_STRIPED, isStriped: isStriped };
	}

	function changeText(isText) {
		return { type: CHANGE_TEXT, isText: isText };
	}

	function changeActive(isActive) {
		return { type: CHANGE_ACTIVE, isActive: isActive };
	}

	function changColor(colorType) {
		return { type: CHANGE_COLOR, colorType: colorType };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProcessBar = __webpack_require__(184);

	var _ProcessBar2 = _interopRequireDefault(_ProcessBar);

	var _ValuePanel = __webpack_require__(185);

	var _ValuePanel2 = _interopRequireDefault(_ValuePanel);

	var _ProcessStyle = __webpack_require__(186);

	var _ProcessStyle2 = _interopRequireDefault(_ProcessStyle);

	var _ProcessColor = __webpack_require__(187);
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				var processValue = _props.processValue;
				var isStriped = _props.isStriped;
				var isText = _props.isText;
				var isActive = _props.isActive;
				var colorType = _props.colorType;

				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_ProcessBar2.default, { processValue: processValue, isStriped: isStriped, isActive: isActive, isText: isText, colorType: colorType }),
					_react2.default.createElement(_ValuePanel2.default, { processValue: processValue, onChangeValue: function onChangeValue(value) {
							return dispatch((0, _actions.changeValue)(value));
						} }),
					_react2.default.createElement(_ProcessStyle2.default, { isStriped: isStriped, isText: isText, isActive: isActive,
						onChangeStriped: function onChangeStriped(isStriped) {
							return dispatch((0, _actions.changeStriped)(isStriped));
						},
						onChangeActive: function onChangeActive(isActive) {
							return dispatch((0, _actions.changeActive)(isActive));
						},
						onChangeText: function onChangeText(isText) {
							return dispatch((0, _actions.changeText)(isText));
						} }),
					_react2.default.createElement(_ProcessColor2.default, { onChangeColor: function onChangeColor(colorType) {
							return dispatch((0, _actions.changColor)(colorType));
						} })
				);
			}
		}]);
	...
	App.PropTypes = {
		processValue: _react.PropTypes.number.isRequired,
		isStriped: _react.PropTypes.bool.isRequired,
		isText: _react.PropTypes.bool.isRequired,
		isActive: _react.PropTypes.bool.isRequired,
		colorType: _react.PropTypes.oneOf(['progress-bar-success', 'progress-bar-info', 'progress-bar-warning', 'progress-bar-danger']).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProcessBar = function (_Component) {
	  ...
	  function ProcessBar() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProcessBar).apply(this, arguments));
	  }
	  ...
	  _createClass(ProcessBar, [{
	    ...
	    value: function render() {
	      //样式1
	      var striped = this.props.isStriped ? ' progress-striped ' : '';
	      var active = this.props.isActive ? ' active ' : '';
	      var text = this.props.isText ? this.props.processValue + '%' : '';
	      var ProcessBarStyle = striped + active + ' progress ';
	      //样式2
	      var ProcessColor = this.props.colorType + ' progress-bar ';
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: ProcessBarStyle },
	          _react2.default.createElement(
	            'div',
	            { className: ProcessColor, role: 'progressbar',
	              'aria-valuenow': '15', 'aria-valuemin': '0', 'aria-valuemax': '100', style: { width: this.props.processValue + '%' } },
	            text
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValuePanel = function (_Component) {
		_inherits(ValuePanel, _Component);

		function ValuePanel() {
			_classCallCheck(this, ValuePanel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ValuePanel).apply(this, arguments));
		}

		_createClass(ValuePanel, [{
			key: 'render',
			value: function render() {
				var _this2 = this;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						'进度：',
						_react2.default.createElement('input', { type: 'number', ref: 'valueInput', onChange: function onChange() {
								return _this2.changeValueByInput();
							},
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							{ className: 'btn btn-primary', onClick: function onClick() {
									return _this2.changeValueByBtn(20);
								} },
							'20%'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: function onClick() {
									return _this2.changeValueByBtn(40);
								} },
							'40%'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: function onClick() {
									return _this2.changeValueByBtn(60);
								} },
							'60%'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: function onClick() {
									return _this2.changeValueByBtn(80);
								} },
							'80%'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: function onClick() {
									return _this2.changeValueByBtn(100);
								} },
							'100%'
						)
					)
			...
			key: 'changeValueByInput',
			value: function changeValueByInput() {
				var node = this.refs.valueInput;
				var value = node.value.trim();
				this.props.onChangeValue(value);
			}
		}, {
			key: 'changeValueByBtn',
			value: function changeValueByBtn(value) {
				this.props.onChangeValue(value);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProcessStyle = function (_Component) {
	  _inherits(ProcessStyle, _Component);

	  function ProcessStyle() {
	    _classCallCheck(this, ProcessStyle);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProcessStyle).apply(this, arguments));
	  }

	  _createClass(ProcessStyle, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "label",
	            null,
	            _react2.default.createElement("input", { type: "checkbox", checked: this.props.isStriped, onChange: function onChange() {
	                return _this2.changeStriped();
	              } }),
	            "斑马纹"
	          ),
	          _react2.default.createElement(
	            "label",
	            null,
	            _react2.default.createElement("input", { type: "checkbox", checked: this.props.isText, onChange: function onChange() {
	                return _this2.changeText();
	              } }),
	            "显示文字"
	          ),
	          _react2.default.createElement(
	            "label",
	            null,
	            _react2.default.createElement("input", { type: "checkbox", checked: this.props.isActive, onChange: function onChange() {
	                return _this2.changeActive();
	              } }),
	            "动态"
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProcessColor = function (_Component) {
	  _inherits(ProcessColor, _Component);

	  function ProcessColor() {
	    _classCallCheck(this, ProcessColor);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProcessColor).apply(this, arguments));
	  }

	  _createClass(ProcessColor, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "select",
	            { className: "form-controll", ref: "aa", onChange: function onChange() {
	                return _this2.changColor();
	              } },
	            _react2.default.createElement(
	              "option",
