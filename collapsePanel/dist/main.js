...
/***/ function(module, exports, __webpack_require__) {
	...
	var _panelApp = __webpack_require__(183);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		{ store: store },
		_react2.default.createElement(_panelApp2.default, null)
	), ele);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var panelState = (0, _redux.combineReducers)({
		toggleState: toggleState,
		closeState: closeState
	});

	exports.default = panelState;
...
/***/ function(module, exports) {
	...
	//actions类型
	var TOGGLE_PANEL = exports.TOGGLE_PANEL = 'TOGGLE_PANEL';
	var CLOSE_PANEL = exports.CLOSE_PANEL = 'CLOSE_PANEL';

	//创建action对象字面量
	function togglePanel(isOpened) {
		return { type: TOGGLE_PANEL, isOpened: isOpened };
	}

	function closePanel(isClosed) {
		return { type: CLOSE_PANEL, isClosed: isClosed };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PanelHead = __webpack_require__(184);

	var _PanelHead2 = _interopRequireDefault(_PanelHead);

	var _PanelBody = __webpack_require__(185);
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				var isToggle = _props.isToggle;
				var isClose = _props.isClose;
				//样式一

				var displayTag = isClose ? 'none' : 'block';
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(
						'div',
						{ className: 'panel panel-default', style: { display: displayTag } },
						_react2.default.createElement(_PanelHead2.default, { isToggle: isToggle,
							onToggleChange: function onToggleChange(value) {
								return dispatch((0, _actions.togglePanel)(value));
							},
							onCloseChange: function onCloseChange(value) {
								return dispatch((0, _actions.closePanel)(value));
							} }),
						_react2.default.createElement(_PanelBody2.default, { isToggle: isToggle })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelHead = function (_Component) {
		_inherits(PanelHead, _Component);

		function PanelHead() {
			_classCallCheck(this, PanelHead);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(PanelHead).apply(this, arguments));
		}
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('span', { className: toggleStyle, onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelBody = function (_Component) {
		...
		function PanelBody() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PanelBody).apply(this, arguments));
		}
